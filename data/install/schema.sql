...
CREATE TABLE `OMEKA_TABLE_PREFIX_property_override` (
  ...
  CONSTRAINT `FK_8BBC5FA1448CC1BD` FOREIGN KEY (`resource_class_id`) REFERENCES `OMEKA_TABLE_PREFIX_resource_class` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `OMEKA_TABLE_PREFIX_site_resource` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FK_375833B089329D25` FOREIGN KEY (`resource_id`) REFERENCES `OMEKA_TABLE_PREFIX_resource` (`id`),
  CONSTRAINT `FK_375833B094221246` FOREIGN KEY (`assigner_id`) REFERENCES `OMEKA_TABLE_PREFIX_user` (`id`),
  CONSTRAINT `FK_375833B0F6BD1646` FOREIGN KEY (`site_id`) REFERENCES `OMEKA_TABLE_PREFIX_site` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
