...
CREATE TABLE omeka_resource_class (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, vocabulary_id INT DEFAULT NULL, local_name VARCHAR(255) DEFAULT NULL, `label` VARCHAR(255) NOT NULL, comment LONGTEXT DEFAULT NULL, resource_type VARCHAR(255) NOT NULL, is_default TINYINT(1) NOT NULL, INDEX IDX_9FC4DAC27E3C61F9 (owner_id), INDEX IDX_9FC4DAC2AD0E05F6 (vocabulary_id), UNIQUE INDEX default_resource_type (resource_type, is_default), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
