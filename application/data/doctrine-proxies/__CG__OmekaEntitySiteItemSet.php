 ...
 */
class SiteItemSet extends \Omeka\Entity\SiteItemSet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Omeka\\Entity\\SiteItemSet' . "\0" . 'site', '' . "\0" . 'Omeka\\Entity\\SiteItemSet' . "\0" . 'itemSet', 'position'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SiteItemSet $proxy) {
