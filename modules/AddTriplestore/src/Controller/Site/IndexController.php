    ...
    public function xmlTtlConverter($rdfXmlData)
{
    ...
    $ttlData = $this->addPrefixesToTTL($ttlData, [
        ...
        'ah-base' => 'http://www.purl.org/ah/kos/ah-base/',
    ...
    // Check for the presence of <crmarchaeo:A9_Archaeological_Excavation rdf:about="http://www.arch-project.com/data/excavation1">
    if (strpos($ttlData, '<crmarchaeo:A9_Archaeological_Excavation rdf:about="http://www.arch-project.com/data/excavation1">') !== false) {
        $patterns = [
        ...
        // Default patterns for other types (or "arrowhead" if not explicitly handled)
        $patterns = [
            '/<ah-shape:([^>]+)>/' => 'ah-shape:$1',
