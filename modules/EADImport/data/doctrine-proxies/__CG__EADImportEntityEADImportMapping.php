 ...
 */
class EADImportMapping extends \EADImport\Entity\EADImportMapping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EADImportMapping $proxy) {
