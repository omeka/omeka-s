 ...
 */
class EADImportEntity extends \EADImport\Entity\EADImportEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'job', 'site', 'entity_id', 'resource_type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EADImportEntity $proxy) {
