...
class MappingFeature extends \Mapping\Entity\MappingFeature implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'item', 'media', 'label', 'geography'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MappingFeature $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setGeography(\LongitudeOne\Spatial\PHP\Types\Geography\GeographyInterface $geography)
    {
