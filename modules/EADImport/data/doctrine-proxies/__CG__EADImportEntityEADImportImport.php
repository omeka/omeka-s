 ...
 */
class EADImportImport extends \EADImport\Entity\EADImportImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'job', 'site', 'name', 'resource_type', 'mapping'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EADImportImport $proxy) {
