 ...
 */
class ResourceClass extends \Omeka\Model\Entity\ResourceClass implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'owner', 'vocabulary', 'localName', 'label', 'comment', 'resources');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResourceClass $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setVocabulary(\Omeka\Model\Entity\Vocabulary $vocabulary = NULL)
    {
