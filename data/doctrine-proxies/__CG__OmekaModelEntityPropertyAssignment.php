 ...
 */
class PropertyAssignment extends \Omeka\Model\Entity\PropertyAssignment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'propertyAssignmentSet', 'property', 'alternateLabel', 'alternateComment');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PropertyAssignment $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setPropertyAssignmentSet(\Omeka\Model\Entity\PropertyAssignmentSet $propertyAssignmentSet = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPropertyAssignmentSet', array($propertyAssignmentSet));

        return parent::setPropertyAssignmentSet($propertyAssignmentSet);
    }
    ...
    public function getPropertyAssignmentSet()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPropertyAssignmentSet', array());

        return parent::getPropertyAssignmentSet();
    }

    /**
     * {@inheritDoc}
     */
    public function setProperty(\Omeka\Model\Entity\Property $property)
    {
